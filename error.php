...
<html>
    <head>
        ...
        <title>ERROR - Coderdojo IBM</title>
  ...
  $('a[href*="#"]:not([href="#"])').click(function() {
	...
	<div id="wrapper">
		...
		<div id="content">
		<div id="coursesIntro"><h6>ERROR</h6></div>
		
		<div id="about" class="generated">
		
			
			<p style="font-size:24px;"><b>Try going to the <a href="http://ibmcorkcoderdojo.com">home page</a> :(</b></p>
			<br>
